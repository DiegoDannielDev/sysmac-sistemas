...
import br.com.sysmac.servico.UsuarioService;
import br.com.sysmac.util.AppContext;
import br.com.sysmac.util.CriptografiaSenha;
...
public class FormUsuarios extends javax.swing.JInternalFrame {
    ...
    public Usuario initSave() throws UnsupportedEncodingException, NoSuchAlgorithmException {
        ...
        JOptionPane.showMessageDialog(rootPane, new Object[]{"Digite sua senha", jpf}, "Senha:", JOptionPane.PLAIN_MESSAGE);
        JOptionPane.showMessageDialog(rootPane, new Object[]{"Digite sua senha novamente", jpf2}, "Senha:", JOptionPane.PLAIN_MESSAGE);

        String senha1 = String.valueOf(jpf.getPassword());
        String senha2 = String.valueOf(jpf2.getPassword());

        if (senha1.equals(senha2)) {

            usuario.setSenhaUser(CriptografiaSenha.converteSenha(senha2));
    ...
    public void deleteUsuario() {
        Boolean ok = this.service.deleteUsuario(Long.parseLong(txtCodigoUser.getText()));
        if (ok) {
...
//        Usuario usuario = new Usuario();
//        usuario.setCodigoUser(Long.parseLong(txtCodigoUser.getText()));
//        usuario.setNomeUser(txtNomeUser.getText());
//        usuario.setLoginUser(txtLoginUser.getText());
//        usuario.setEmailUser(txtEmailUser.getText());
//
...
//    }
    public void findCodigo() {

        Long id = service.findCodigo();
        txtCodigoUser.setText(String.valueOf(id));
    }
    ...
    private void btnGravarActionPerformed(java.awt.event.ActionEvent evt) throws UnsupportedEncodingException, NoSuchAlgorithmException {//GEN-FIRST:event_btnGravarActionPerformed
